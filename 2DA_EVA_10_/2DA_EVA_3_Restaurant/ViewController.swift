...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBOutlet weak var tableViewRest: UITableView!
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "detalle"{
            ...
            let miDetalleViewController = segue.destinationViewController as! DetalleViewController
            miDetalleViewController.sNomImg = imagenes[indexPath.row]
            miDetalleViewController.sResImg = misDatos [indexPath.row]
